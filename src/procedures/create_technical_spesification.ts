...
BEGIN
    technical_spec_no_ := ifsapp.TECHNICAL_OBJECT_REFERENCE_API.Get_Technical_Spec_No('PartCatalog', 'PART_NO=' ||Prefix_Part_No__(rec_.c01) || '^');
...
export const create_technical_spesification = async () => {
